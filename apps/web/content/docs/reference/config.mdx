...
PPTX export is optimized first for Microsoft PowerPoint Desktop on Windows and
Mac. Other editors may open the generated file, but compatibility there is
best-effort.
